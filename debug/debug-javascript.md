...
WordPress uses minified JavaScript by default. Enabling [script debugging](https://developer.wordpress.org/advanced-administration/debug/debug-wordpress/#script_debug) forces WordPress to load the full, uncompressed versions, which makes errors easier to trace.
